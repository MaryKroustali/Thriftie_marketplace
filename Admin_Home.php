...
<html>
    ...
    <body>
        ...
        <section id="admin_home">
            <p>The following products are not assigned a category yet.</p>
            <div class="container">
        ...
        <!--footer-->
        <footer class="text-right" style="position:fixed;bottom:0;width:100%;"> <!--position footer at the bottom-->
            <br><br>
